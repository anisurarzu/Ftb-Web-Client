...
const Banner = ({ hotels }) => {
  const banners = [
    {
      ...
      gradient: "bg-gradient-to-r from-black/80 to-black/50",
    },
    {
      ...
      gradient: "bg-gradient-to-r from-black/70 to-black/40",
    },
    {
  ...
  return (
    <div className="w-full relative">
      ...
      >
        {banners.map((banner, index) => (
          <div key={index} className="relative">
            ...
            {/* Black Gradient Overlay - More Minimal */}
              ...
              <div className="text-center space-y-6 px-4 max-w-4xl w-full">
                ...
                >
                  {/* <Button
                    type="primary"
                    size="large"
                    className="bg-white text-black hover:bg-gray-100 border-none px-8 h-12 font-medium shadow-sm"
                  >
                    Explore Now
                  </Button> */}
                </motion.div>
      ...
      {/* Search Bar - Positioned higher than before but not at the very top */}
      <div
        className="w-full z-10 px-4
          lg:absolute lg:bottom-8 lg:left-0
